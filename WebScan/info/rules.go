...
var RuleDatas = []RuleData{
	...
	{"金山 V8 √", "code", "(北京金山安全管理系统技术有限公司|金山V8)"},
	{"金山 V9 √", "code", "(金山终端安全系统V9.0Web控制台)"},
	{"金山 √", "code", "(北京猎鹰安全科技有限公司)"},
	...
	{"金蝶政务GSiS √", "code", "(/kdgs/script/kdgs.js)"},
	{"金蝶EAS √", "code", "(easSessionId)"},
	{"用友ufida √", "code", "(/System/Login/Login.asp?AppID=)"},
	...
	{"用友erp-nc √", "code", "(/nc/servlet/nc.ui.iufo.login.Index)"},
